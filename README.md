...
```bash
gh release download v0.12.7 --repo teleport-computer/memgarden --pattern '*.whl'
gh attestation verify memgarden-0.12.7-py3-none-any.whl --repo teleport-computer/memgarden
```
